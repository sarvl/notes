...
Arithmetic Logic Unit is the basic execution unit of [[Central_Processing_Unit]]. It performs: [[Arithmetic_Logic_Unit#Binary Adder|Addition/Subtraction]], [[Logic_Gate|Logic Operations]], and sometimes [[Binary_Multiplication|Multiplication]] and [[Binary_Division|Division]].  ALU is simply a [[Multiplexer|Mux]] between these operations.
