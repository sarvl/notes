...
### Parity Check
Add a single [[Number_System#Binary|Bit]] that makes total count of $1$s even or odd. For example $10101$ with even parity is $10101'1$. When the sum of $1$s is not even/odd on the receiver end, there must have been odd number of errors.

### Checksum
Add several bits denoting total sum of [[Number_System#Binary|bits]]. For example $1011$ will turn into $1011'10$.
