...
## Structure
While usually a proof is expressed as a sentence, a proof structure constructed in a way similar to [[Programming_Paradigm#Structured Programming|Structured Programming]] - decomposing it into basic building blocks, each proving a certain [[Logic#Sentence|Sentence]].
